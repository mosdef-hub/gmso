...
input_base_mie_form = "(n/(n-m)) * (n/m)**(m/(n-m)) * epsilon * ((sigma/r)**n - (sigma/r)**m)"
input_base_exp6_form = "epsilon*alpha/(alpha-6) * (6/alpha*exp(alpha*(1-r/Rmin)) - (Rmin/r)**6)"
...
class TestEqnCompare(BaseTest):
    def test_wrong_lj_equation_form(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_nonbonded_lj_format_with_scaler(input_new_lj_form, input_base_lj_form)
    ...
    def test_wrong_mie_equation_form(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_nonbonded_mie_format_with_scaler(input_new_mie_form, input_base_mie_form)
    ...
    def test_wrong_exp6_equation_form(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_nonbonded_exp6_format_with_scaler(input_new_exp6_form, input_base_exp6_form)
    ...
    def test_find_lj_mie_exp6_forms_and_scalars(self):
        ...
        atom_types_data_expression_data_dict = get_atom_type_expressions_and_scalars(test_atom_types_dict)

        assert str(atom_types_data_expression_data_dict['ETH_CH3']['expression']
                   ) == '4*epsilon*(-sigma**6/r**6 + sigma**12/r**12)'
        assert atom_types_data_expression_data_dict['ETH_CH3']['expression_form'] == 'LJ'
        assert atom_types_data_expression_data_dict['ETH_CH3']['expression_scalar'] == 1.0

        assert str(atom_types_data_expression_data_dict['ETHM_CH3']['expression']
                   ) == 'epsilon*n*(n/m)**(m/(-m + n))*(-(sigma/r)**m + (sigma/r)**n)/(-m + n)'
        assert atom_types_data_expression_data_dict['ETHM_CH3']['expression_form'] == 'Mie'
        assert atom_types_data_expression_data_dict['ETHM_CH3']['expression_scalar'] == 1.0
    ...
    def test_wrong_harmonic_bond(self):
        ...
        [
            form_output,
            form_scalar
        ] =evaluate_harmonic_bond_format_with_scaler(input_new_harmonic_form, input_base_harmonic_bond)
    ...
    def test_wrong_harmonic_angle(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_harmonic_angle_format_with_scaler(input_new_harmonic_form, input_base_harmonic_angle)
    ...
    def test_wrong_harmonic_torsion(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_harmonic_torsion_format_with_scaler(input_new_harmonic_form, input_base_harmonic_torsion)
    ...
    def test_wrong_opls_torsion(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_OPLS_torsion_format_with_scaler(input_new_opls_form, input_base_opls_torsion)
    ...
    def test_wrong_periodic_torsion(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_periodic_torsion_format_with_scaler(input_new_periodic_form, input_base_periodic_torsion)
    ...
    def test_wrong_RB_torsion(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_RB_torsion_format_with_scaler(input_new_RB_form, input_base_RB_torsion)
    ...
    def test_wrong_RB_torsion(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_harmonic_improper_format_with_scaler(input_new_harmonic_improper_form,
    ...
    def test_periodic_improper(self):
        ...
        [
            form_output,
            form_scalar
        ] = evaluate_periodic_improper_format_with_scaler(input_new_periodic_improper_form,
