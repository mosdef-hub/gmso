...
def _write_gmso_xml(gmso_xml, **kwargs):
    ...
    nonBondedAtomTypes.attrib['expression'] = 'ep * ((sigma/r)**12 - (sigma/r)**6) + q / (e0 * r)'
    
    nonBondedAtomTypesParamsUnitsDef_ep = etree.SubElement(nonBondedAtomTypes, 'ParametersUnitDef')
    nonBondedAtomTypesParamsUnitsDef_ep.attrib['parameter'] = 'ep'
    nonBondedAtomTypesParamsUnitsDef_ep.attrib['unit'] = 'kJ/mol'
    nonBondedAtomTypesParamsUnitsDef_sigma = etree.SubElement(nonBondedAtomTypes, 'ParametersUnitDef')
    nonBondedAtomTypesParamsUnitsDef_sigma.attrib['parameter'] = 'sigma'
    nonBondedAtomTypesParamsUnitsDef_sigma.attrib['unit'] = 'nm'
    
    nonBondedAtomTypesParamsUnitsDef_e0 = etree.SubElement(nonBondedAtomTypes, 'ParametersUnitDef')
    nonBondedAtomTypesParamsUnitsDef_e0.attrib['parameter'] = 'e0'
    nonBondedAtomTypesParamsUnitsDef_e0.attrib['unit'] = 'A**2*s**4/(kg*m**3)'
    nonBondedAtomTypesParamsUnitsDef_q = etree.SubElement(nonBondedAtomTypes, 'ParametersUnitDef')
    ...
    harmonicBondTypesParamsUnitsDef_k = etree.SubElement(harmonicBondTypes, 'ParametersUnitDef')
    harmonicBondTypesParamsUnitsDef_k.attrib['parameter'] = 'k'
    harmonicBondTypesParamsUnitsDef_k.attrib['unit'] = 'kJ/mol/nm**2'
    harmonicBondTypesParamsUnitsDef_r_eq = etree.SubElement(harmonicBondTypes, 'ParametersUnitDef')
    ...
    harmonicAngleTypesParamsUnitsDef_k = etree.SubElement(harmonicAngleTypes, 'ParametersUnitDef')
    harmonicAngleTypesParamsUnitsDef_k.attrib['parameter'] = 'k'
    harmonicAngleTypesParamsUnitsDef_k.attrib['unit'] = 'kJ/degree**2'
    
    harmonicBondTypesParamsUnitsDef_theta_eq = etree.SubElement(harmonicAngleTypes, 'ParametersUnitDef')
    harmonicBondTypesParamsUnitsDef_theta_eq.attrib['parameter'] = 'theta_eq'
    harmonicBondTypesParamsUnitsDef_theta_eq.attrib['unit'] = 'degree'
    ...
    ureybradleyAngleTypesParamsUnitsDef_k = etree.SubElement(ureybradleyAngleTypes, 'ParametersUnitDef')
    ureybradleyAngleTypesParamsUnitsDef_k.attrib['parameter'] = 'k'
    ureybradleyAngleTypesParamsUnitsDef_k.attrib['unit'] = 'kJ/degree**2'
    
    ureybradleyAngleTypesParamsUnitsDef_w_0 = etree.SubElement(ureybradleyAngleTypes, 'ParametersUnitDef')
    ...
    for i, atom_type in enumerate(ff_kwargs['non_bonded_forces']):
        thisAtomType = atomTypes.find('.//AtomType[@name="{}"]'.format(atom_type.get('type')))
    ...
    for i, angle_type in enumerate(ff_kwargs['urey_bradley_angle_types']):
        ...
        thisAngleType.attrib['name'] = angle_type.get('name', 'AngleType-UreyBradley-{}'.format(i+1))
    ...
    for i, dihedral_type in enumerate(ff_kwargs['periodic_torsion_dihedral_types']):
        thisDihedralType = etree.SubElement(periodicTorsionDihedralTypes,
                'DihedralType')
    ...
    for k in range(1, max_j):
        periodicTorsionDihedralTypesParamsUnitsDef_k = etree.Element('ParametersUnitDef')
        periodicTorsionDihedralTypesParamsUnitsDef_k.attrib['parameter'] = 'k{}'.format(k)
        periodicTorsionDihedralTypesParamsUnitsDef_k.attrib['unit'] = 'kJ'
        periodicTorsionDihedralTypes.insert(0, periodicTorsionDihedralTypesParamsUnitsDef_k)

        periodicTorsionDihedralTypesParamsUnitsDef_n = etree.Element('ParametersUnitDef')
        periodicTorsionDihedralTypesParamsUnitsDef_n.attrib['parameter'] = 'n{}'.format(k)
        periodicTorsionDihedralTypesParamsUnitsDef_n.attrib['unit'] = 'dimensionless'
        periodicTorsionDihedralTypes.insert(0, periodicTorsionDihedralTypesParamsUnitsDef_n)

        periodicTorsionDihedralTypesParamsUnitsDef_del = etree.Element('ParametersUnitDef')
        periodicTorsionDihedralTypesParamsUnitsDef_del.attrib['parameter'] = 'delta{}'.format(k)
...
def _write_foyer_xml(foyer_xml, **kwargs):
    ...
    for rbtype in ff_kwargs['rb_torsion_dihedral_types']:
        rbt = etree.SubElement(rbtypes, 'Proper')

        # Set RBTorsion information
        rbt.attrib['type1'] = rbtype.get('type1')
        rbt.attrib['type2'] = rbtype.get('type2')
