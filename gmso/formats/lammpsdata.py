        ...
        if topology.is_typed():
            ...
            for idx, param in enumerate(topology.atom_types):
                ...
                if sympify(param.expression).equals(sympify(lj_expression)):
                    ...
                    scaling_factor := simplify(lj_expression)
                    / simplify(param.expression)
                ).is_real:
                    data.write(
                        "{}\t{:.5f}\t{:.5f}\n".format(
                            idx + 1,
            ...
            if topology.bonds:
                ...
                for idx, bond_type in enumerate(topology.bond_types):
                    ...
                    if sympify(bond_type.expression).equals(
                        sympify(bond_expression)
                    ):
                        data.write(
                            "{}\t{:.5f}\t{:.5f}\n".format(
                                idx + 1,
                    ...
                    elif sympify(bond_type.expression).equals(
                        sympify("0.5 * k * (r-r_eq)**2")
                    ):
                        data.write(
                            "{}\t{:.5f}\t{:.5f}\n".format(
                                idx + 1,
                        ...
                        scaling_factor := simplify(bond_expression)
                        / simplify(bond_type.expression)
                    ).is_real:
                        data.write(
                            "{}\t{:.5f}\t{:.5f}\n".format(
                                idx + 1,
            ...
            if topology.angles:
                ...
                for idx, angle_type in enumerate(topology.angle_types):
                    ...
                    if sympify(angle_type.expression).equals(
                        sympify(angle_expression)
                    ):
                        data.write(
                            "{}\t{:.5f}\t{:.5f}\n".format(
                                idx + 1,
                    ...
                    elif sympify(angle_type.expression).equals(
                        sympify("0.5 * k * (theta - theta_eq)**2")
                    ):
                        data.write(
                            "{}\t{:.5f}\t{:.5f}\n".format(
                                idx + 1,
                        ...
                        scaling_factor := simplify(angle_expression)
                        / simplify(angle_type.expression)
                    ).is_real:
                        data.write(
                            "{}\t{:.5f}\t{:.5f}\n".format(
                                idx + 1,
